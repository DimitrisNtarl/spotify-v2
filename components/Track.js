...
function Track({ track, chooseTrack }) {
  ...
  return (
    <div className="flex items-center justify-between space-x-0 cursor-default hover:bg-white/10 py-2 px-4 rounded-lg group transition ease-out">
      ...
      <div className="md:ml-auto flex items-center space-x-2.5">
        ...
        <div className="flex items-center rounded-full border-2 border-[#262626] w-[85px] h-10 relative cursor-pointer group-hover:border-[#15883e]">
          <AiFillHeart
            className={`text-xl ml-3 icon ${
              hasLiked ? "text-[#15883e]" : "text-[#868686]"
            }`}
          ...
          {track.uri === playingTrack.uri && play ? (
            ...
            <>
              <div
                className="h-10 w-10 rounded-full border border-[#15883e] flex items-center justify-center absolute -right-0.5 hover:bg-[#15883e] hover:border-[#15883e] icon hover:scale-110"
                onClick={handlePlay}
              >
